...
describe('ProductCategory e2e test', () => {
  ...
  it('should load ProductCategories', async () => {
    ...
    expect(await productCategoryComponentsPage.getTitle()).to.eq('onlinestore1App.productCategory.home.title');
    await browser.wait(
  ...
  it('should load create ProductCategory page', async () => {
    ...
    expect(await productCategoryUpdatePage.getPageTitle()).to.eq('onlinestore1App.productCategory.home.createOrEditLabel');
  ...
  it('should delete last ProductCategory', async () => {
    ...
    expect(await productCategoryDeleteDialog.getDialogTitle()).to.eq('onlinestore1App.productCategory.delete.question');
