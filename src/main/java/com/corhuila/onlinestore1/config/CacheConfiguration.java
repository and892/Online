package com.corhuila.onlinestore1.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("onlinestore1");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("onlinestore1");
        ...
        config.getMapConfigs().put("com.corhuila.onlinestore1.domain.*", initializeDomainMapConfig(jHipsterProperties));
